...
const ProductDetails = () => {
  ...
  const handleThumbnailClick = (image) => {
    setMainImage(image); // Update main image when thumbnail is clicked
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 overflow-hidden">
        ...
        <div className="p-4 flex flex-col">
          ...
          <div className="flex space-x-4">
            <button className="flex-1 bg-richChocolate700 text-white py-2 rounded-lg shadow-md hover:bg-richChocolate800 transition">
