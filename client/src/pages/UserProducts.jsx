          ...
          <div className="relative w-full md:w-1/2 h-fit bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            >
              <Link onClick={() => setIsModalOpen(true)}>
                <PencilSquareIcon className="w-8 h-8 text-richChocolate900 font-bold hover:text-richChocolate900 absolute top-4 right-4 transition-transform transform hover:scale-110" />
              </Link>
